...
$(window).load(function(){
	...
	<table>
		...
		<tr><td style="border-right:solid 1px #eee;border-bottom:solid 1px #eee">Country</td>
		<td style="color:#424854;border-bottom:solid 1px #eee" colspan="2"><?php $rsGeoData = geoip_record_by_addr($gi, $row['ip']);echo "<img src='/images/flags/".strtolower($rsGeoData->country_code).".gif' title='".$rsGeoData->country_name."' alt='".$rsGeoData->country_name."'/> ".$rsGeoData->country_name;?></td></tr>
	</table>
	</div>
	</div>
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="javascript:change_bg(1, 'Normal doge');void(0)" title="Normal doge"><img src="/images/bg.png" alt="Normal doge"/><br/>Normal doge</a></li>
    <li><a href="javascript:change_bg(2, '8-bit doge');void(0)" title="8-bit doge"><img src="/images/bg_8bit.png" alt="8-bit doge"/><br/>8-bit doge</a></li>
    <li><a href="javascript:change_bg(3, 'Neko doge');void(0)" title="Neko doge"><img src="/images/bg_neko.png" alt="Neko doge"/><br/>Neko doge</a></li>
    <li><a href="javascript:change_bg(4, 'Flandre Scarlet doge');void(0)" title="Flandre Scarlet doge"><img src="/images/bg_flandre.png" alt="Flandre Scarlet doge"/><br/>Flandre Scarlet doge</a></li>
    <li><a href="javascript:change_bg(5, 'Snoop Dogge');void(0)" title="Snoop Dogge"><img src="/images/bg_weed.png" alt="Snoop Dogge"/><br/>Snoop Dogge</a></li>
    <li><a href="javascript:change_bg(6, 'Toontown doge');void(0)" title="Toontown doge"><img src="/images/bg_tt.png" alt="Toontown doge"/><br/>Toontown doge</a></li>
  </ul>
</div></td></tr>
		<tr><td style="border-right:solid 1px #eee;border-bottom:solid 1px #eee">
		Font
